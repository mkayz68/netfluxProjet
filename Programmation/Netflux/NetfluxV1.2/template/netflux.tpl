                ...
                <div class="row justify-content-md-center">
                    {foreach from=$tabSeries item=$serie}
                        <div class="col-md-auto border border-dark">
                            <h3><strong>{$serie->getNomSerie()}</strong></h3>
                            <p><strong>Date de Début :</strong> {$serie->getDateDebut()|date_format:"%d/%m/%Y"}</p>
                            {if ($serie->getDateFin() == null)}
                                <p><strong>Date de fin :</strong> En cours</p>
                            {/if}
                            <p><strong>Nombres de Saisons :</strong> {$serie->getNbrSaisons()}</p>
