<?php
/* Smarty version 3.1.33, created on 2019-05-02 19:45:25
  from '/Applications/MAMP/htdocs/Netflux/NetfluxV01/template/header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ccb48d5d7b828_91206493',
...
function content_5ccb48d5d7b828_91206493 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
    <html lang="fr">
        <head>
            <meta charset="UTF-8">
                ...
                <ul class="nav justify-content-start mr-auto p-2">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border border-white text-white bg-dark">
                            ...
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['tabCategories']->value, 'categorie');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['categorie']->value) {
?>
                                <a class="dropdown-item" href="#">-<?php echo $_smarty_tpl->tpl_vars['categorie']->value->getTypeCategorie();?>
</a>
                            <?php
}
}
