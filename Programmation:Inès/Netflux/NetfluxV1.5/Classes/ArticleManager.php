<?php
    ...
    class ArticleManager
    {
        ...
        //Method pour afficher un article via son ID
        public function get()
        {
            $idArticle = (int)$idArticle;

	        $sql = $this->_bdd->query('SELECT * FROM Article WHERE id = '.$idArticle);
        ...
        public function getNomSerieByArticle($idSerie)
        {
            ...
            $sql = $this->_bdd->query('SELECT nomSerie FROM Serie INNER JOIN Article 
