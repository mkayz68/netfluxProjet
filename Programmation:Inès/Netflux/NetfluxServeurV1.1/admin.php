<?php
    ...
    if(isset($_POST['creerArticle']))
    {
        ...
        if ($envoiBdd)
        {
            ...
            if ($donnees == 1 AND !empty($_FILES['imageArticle']))
            { 
    ...
    if(isset($_POST['modifierSerie']))
    {
        ...
        else
        {
            ...
            if (!empty($_FILES['imageSynop']) AND $_FILES['imageSynop']['error'] > 0 )
            {
                $tabMessage[] = 'Erreur lors du transfert';
            }
            elseif (!empty($_FILES['imageSynop']) AND $_FILES['imageSynop']['error'] == 0)
    ...
    if(isset($_POST['modifierArticle']))
    {
        ...
        //Conditions pour l'image
        if (!empty($_FILES['imageArticle']) AND $_FILES['imageArticle']['error'] > 0 )
        {
            $tabMessage[] = 'Erreur lors du transfert';
        }
        elseif (!empty($_FILES['imageArticle']) AND $_FILES['imageArticle']['error'] == 0)
        {
